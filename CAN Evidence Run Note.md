...
- Other relevant wiring/setup notes:
...
- Console capture started at:

- Robot booted at:

- Startup idle window length:

- Manual test sequence used:

- Post-test idle window length:

- Console capture stopped at:
...
- Whether the correct device responded:

- Whether any wrong device responded:

- Any intermittent or degraded behavior:
