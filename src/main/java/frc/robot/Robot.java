...
/**
 * NAME
 *   Robot - Primary bringup robot program.
 *
 * DESCRIPTION
...
public class Robot extends TimedRobot {
  ...
  /**
   * NAME
   *   Robot - Construct the primary bringup robot program.
   *
   * DESCRIPTION
   *   Performs the one-time startup work previously handled by robotInit so
   *   initialization is complete during construction.
   */
  public Robot() {
