...
public final class RevSparkMaxReader {
   ...
   *
   * SYNOPSIS
   * Capture a snapshot from a Spark Max device at the requested detail level.
   *
   * PARAMETERS
   * device - Spark Max instance to read.
   * canId - CAN ID of the device.
   ...
   * A populated device snapshot with REV motor telemetry.
   */
  public static DeviceSnapshot read(SparkMax device, int canId, SnapshotDetail detail) {
