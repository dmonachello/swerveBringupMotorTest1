...
SPEC = ParserSpec(
    ...
    common=('exit', 'end', 'help', 'ping', 'echo', 'sleep', 'messages', 'tiu', 'quit'),
    show_flags=('--json', '--pretty', '--grouped', 'robot', '--robot', 'local', '--local', 'both', '--both'),
    show_source_robot='robot',
    show_source_local='local',
    show_source_both='both',
    show_targets=('status', 'groups', 'group', 'devices', 'device', 'signals', 'signal', 'commands', 'help', 'version', 'device-usage', 'binding-usage', 'visibility', 'input-aliases', 'bindings', 'active', 'instantiated', 'faults', 'can-mappings', 'selected-device', 'safety-latch', 'runtime-state', 'runtime-components', 'tests', 'test', 'config', 'sources', 'profiles', 'profile', 'message-level', 'workspace', 'controllers', 'device-group', 'device-meta', 'topology', 'neighbors'),
    ...
    cmd_merge_flag='--merge',
    cmd_replace_flag='--replace',
    ...
    mode_exec_cmds=('active', 'add', 'bindings', 'clear', 'configure', 'connect', 'diagnose', 'disconnect', 'profile', 'reset', 'run', 'show', 'tests'),
    mode_config_cmds=('add', 'bindings', 'can-mappings', 'clear', 'config', 'copy', 'device', 'diagnose', 'export', 'group', 'import', 'load', 'ls', 'merge', 'no', 'profile', 'profiles', 'recover', 'remove', 'rename', 'run', 'save', 'selected-device', 'selected-mode', 'show', 'test', 'tests', 'topology', 'val', 'validate'),
    ...
    mode_test_cmds=('abort', 'action', 'brightness', 'color', 'command', 'deadband', 'deadbandsweep', 'device', 'duration', 'duty', 'enabled', 'expect', 'hold', 'inputsource', 'limitswitch', 'manual_stop', 'no', 'passive', 'pattern', 'rotation', 'show', 'success', 'termination', 'time', 'type', 'until'),
