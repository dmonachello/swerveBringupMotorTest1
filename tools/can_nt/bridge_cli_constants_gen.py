...
SPEC = ParserSpec(
    ...
    common=('exit', 'end', 'help', 'ping', 'echo', 'sleep', 'messages', 'quit'),
    ...
    show_targets=('status', 'groups', 'group', 'devices', 'device', 'commands', 'help', 'version', 'device-usage', 'binding-usage', 'visibility', 'input-aliases', 'bindings', 'can-mappings', 'selected-device', 'safety-latch', 'runtime-state', 'lifecycle-state', 'runtime-components', 'tests', 'test', 'config', 'sources', 'profiles', 'profile', 'message-level', 'workspace', 'controllers', 'device-group', 'device-meta', 'topology'),
    ...
    mode_exec_cmds=('active', 'bindings', 'clear', 'configure', 'connect', 'diagnose', 'disconnect', 'instantiate', 'profile', 'reset', 'run', 'runtime', 'show', 'tests'),
    mode_config_cmds=('bindings', 'can-mappings', 'clear', 'config', 'copy', 'device', 'diagnose', 'export', 'group', 'import', 'instantiate', 'load', 'ls', 'member', 'merge', 'no', 'profile', 'profiles', 'recover', 'rename', 'run', 'runtime', 'save', 'selected-device', 'selected-mode', 'show', 'test', 'tests', 'topology', 'val', 'validate'),
    mode_group_cmds=('bind', 'clear', 'disable', 'enable', 'member', 'no', 'run', 'show'),
