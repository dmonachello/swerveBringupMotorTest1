...
SPEC = ParserSpec(
    ...
    mode_config_cmds=('add', 'bindings', 'can-mappings', 'clear', 'config', 'copy', 'device', 'diagnose', 'export', 'group', 'import', 'load', 'ls', 'merge', 'no', 'profile', 'profiles', 'recover', 'remove', 'rename', 'run', 'save', 'selected-device', 'selected-mode', 'show', 'test', 'tests', 'val', 'validate'),
