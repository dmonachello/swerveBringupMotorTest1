...
SPEC = ParserSpec(
    ...
    show_targets=('status', 'groups', 'group', 'devices', 'device', 'commands', 'help', 'version', 'device-usage', 'binding-usage', 'visibility', 'input-aliases', 'bindings', 'can-mappings', 'selected-device', 'safety-latch', 'runtime-state', 'runtime-components', 'tests', 'test', 'config', 'sources', 'profiles', 'profile', 'message-level', 'workspace', 'controllers', 'device-group', 'device-meta', 'topology', 'neighbors'),
    ...
    mode_exec_cmds=('active', 'add', 'clear', 'configure', 'connect', 'diagnose', 'disconnect', 'profile', 'reset', 'run', 'show', 'tests'),
