...
common: "exit" | "end" | "help" ( ws name ( ws name )* )? | "ping" | "echo" ws ("on" | "off") | "quit" 
exec: show_exec | "configure" ws "terminal" | "connect" | "disconnect" 
show_exec: "show" ws show_target ( ws show_flags )? 
show_target: "status" | "groups" | "group" ws name | "devices" | "device" ws name | "device" ws "registry" ws name | "bindings" | "selected-device" | "runtime-state" | "config" | "config" ws "local-raw" | "config" ws "dirty" | "profiles" | "profile" ( ws name )? | "tests" | "test" ws name 
...
tests_args: "templates" | "load" ws path | "load" ws "template" ws name | "save" | "clear" 
...
device: "show" | "show" ws show_target ( ws show_flags )? | "set" ws device_field ws value_or_text | "no" ws device_field | "write" ws "tests" ws path 
