...
def _write_constants(meta: Dict[str, object]) -> None:
    ...
    lines.append(f"    show_targets={tuple(meta['show_targets'])!r},")
    lines.append(f"    show_target_config={meta['show_targets'][-1]!r},")
    lines.append(f"    show_target_runtime_state={meta['show_targets'][7]!r},")
    lines.append(f"    show_target_tests={meta['show_targets'][8]!r},")
    lines.append(f"    show_target_test={meta['show_targets'][9]!r},")
    ...
    lines.append(f"    show_target_group={meta['show_targets'][2]!r},")
    lines.append(f"    show_target_device={meta['show_targets'][4]!r},")
