...
def _write_constants(meta: Dict[str, object], mode_commands: Dict[str, tuple[str, ...]]) -> None:
    ...
    lines.append("    show_target_sources: str")
    lines.append("    show_target_device_usage: str")
    lines.append("    show_target_device_group: str")
    ...
    lines.append("    cmd_load: str")
    lines.append("    cmd_reload: str")
    ...
    lines.append("    cmd_merge_flag: str")
    lines.append("    cmd_replace_flag: str")
    ...
    lines.append("    msg_push_requires: str")
    lines.append("    msg_save_requires: str")
    lines.append("    msg_save_target: str")
    lines.append("    msg_load_requires: str")
    lines.append("    msg_write_requires: str")
    ...
    lines.append("    kind_exec_add_next: str")
    lines.append("    kind_exec_add_all: str")
    lines.append("    kind_exec_tests_select: str")
    lines.append("    kind_exec_tests_toggle: str")
    lines.append("    kind_exec_tests_activate: str")
    lines.append("    kind_exec_tests_deactivate: str")
    lines.append("    kind_exec_tests_run: str")
    lines.append("    kind_exec_tests_run_all: str")
    ...
    lines.append(f"    show_target_device_group={_target('device-group')!r},")
    lines.append(f"    show_target_commands={_target('commands')!r},")
    lines.append(f"    show_target_help={_target('help')!r},")
    lines.append(f"    show_target_sources={_target('sources')!r},")
    ...
    lines.append(f"    cmd_activate_profile={commands['activate_profile']!r},")
    ...
    lines.append(f"    cmd_sources={commands['sources']!r},")
    ...
    lines.append(f"    cmd_load={commands['load']!r},")
    lines.append(f"    cmd_reload={commands['reload']!r},")
    ...
    lines.append(f"    cmd_merge_flag={commands['merge_flag']!r},")
    lines.append(f"    cmd_replace_flag={commands['replace_flag']!r},")
    ...
    lines.append(f"    msg_push_requires={messages['push_requires']!r},")
    lines.append(f"    msg_save_requires={messages['save_requires']!r},")
    lines.append(f"    msg_save_target={messages['save_target']!r},")
    lines.append(f"    msg_load_requires={messages['load_requires']!r},")
    lines.append(f"    msg_write_requires={messages['write_requires']!r},")
    ...
    lines.append(f"    kind_exec_add_next={kinds['exec_add_next']!r},")
    lines.append(f"    kind_exec_add_all={kinds['exec_add_all']!r},")
    lines.append(f"    kind_exec_tests_select={kinds['exec_tests_select']!r},")
    lines.append(f"    kind_exec_tests_toggle={kinds['exec_tests_toggle']!r},")
    lines.append(f"    kind_exec_tests_activate={kinds['exec_tests_activate']!r},")
    lines.append(f"    kind_exec_tests_deactivate={kinds['exec_tests_deactivate']!r},")
    lines.append(f"    kind_exec_tests_run={kinds['exec_tests_run']!r},")
    lines.append(f"    kind_exec_tests_run_all={kinds['exec_tests_run_all']!r},")
