...
STATUS_MESSAGES = {
    SS__CLI_VALIDATOR__INVALID_VALUE: "Invalid value: {value}.",
    SS__CLI_VALIDATOR__OUT_OF_RANGE: "Value out of range: {value}.",
    SS__CLI_VALIDATOR__REQUIRED: "Required value missing: {field}.",
}
