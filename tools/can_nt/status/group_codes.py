...
STATUS_MESSAGES = {
    SS__GROUP__NOT_FOUND: "Group not found: {group}.",
    SS__GROUP__EMPTY: "Group has no members: {group}.",
    SS__GROUP__MEMBER_MISSING: "Group member not found: {device}.",
    SS__GROUP__BINDING_INVALID: "Invalid binding.",
}
