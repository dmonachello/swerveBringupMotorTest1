    ...
    return [
        ...
        (
            ...
            [
                ...
                "    Output: Updated data/bringup_profiles.json and deploy copy with data_version/data_hash.",
                ...
                "       Commands:",
                "         python -m tools.can_topology.validate_profiles --path data\\bringup_profiles.json --verbose",
                "         python -m tools.sync_profiles",
                "EXAMPLES",
                "    python -m tools.sync_profiles",
                "    python -m tools.sync_profiles --source data\\bringup_profiles.json --dest src\\main\\deploy\\bringup_profiles.json",
            ],
        ),
        (
            ...
            [
                ...
                "    How it works: Reads bringup_profiles.json and renders per-profile diagrams.",
                ...
                "    python -m tools.visualize_profiles --input data\\bringup_profiles.json --output docs\\profiles.html",
            ],
        ),
        (
            ...
            [
                ...
                "    Output: bringup_profiles.json-style payload (single profile).",
                ...
                "       Output: bringup_profiles.json updated and synced to deploy.",
                "       Commands:",
        ...
        (
            ...
            [
                "NAME",
                "    validate_profiles - Validate bringup_profiles.json compatibility.",
                "SYNOPSIS",
                "    Module:",
        ...
        (
            ...
            [
                ...
                "    Output: bringup_profiles.json with optional diagram metadata.",
                ...
                "       Output: Updated bringup_profiles.json, deploy copy, and HTML diagram.",
                "       Commands:",
                "         python -m tools.can_topology.can_top_editor",
                "         python -m tools.sync_profiles",
                "         python -m tools.visualize_profiles",
