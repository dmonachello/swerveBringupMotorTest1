    ...
    return [
        ...
        (
            ...
            [
                ...
                "    Output: Host-local/REST diagnostics, console summaries, and optional PCAP/PCAPNG for Wireshark.",
                "    How it works: Opens a CANable/slcan interface, classifies frames, aggregates rates, and publishes supported diagnostics surfaces.",
        ...
        (
            ...
            [
                "NAME",
                "    validate_sync - Validate and stamp bringup_system.json.",
                "SYNOPSIS",
                "    python -m tools.validate_sync [--lenient] [--no-stamp] [--validate-deploy] [--no-write] [--warnings]",
                "DESCRIPTION",
                "    Purpose: One 'validate + sync' gate after any config/test edits.",
                "    Output: Validated/stamped src/main/deploy/bringup_system.json.",
                "    Notes: Replaces the legacy sync tool (python tools\\sync_profiles.py).",
                "WORKFLOWS",
                "    1) Edit unified config -> validate+sync:",
                "       Commands:",
        ...
        (
            ...
            [
                ...
                "    python -m tools.visualize_profiles --input src\\main\\deploy\\bringup_system.json --output docs\\profiles.html",
            ],
        ),
        (
            ...
            [
                ...
                "       Output: src/main/deploy/bringup_system.json updated.",
                "       Commands:",
        ...
        (
            ...
            [
                ...
                "       Commands:",
                "         python -m tools.can_topology.validate_profiles --path src\\main\\deploy\\bringup_system.json --verbose",
                "         python -m tools.sync_profiles",
                "EXAMPLES",
        ...
        (
            ...
            [
                ...
                "DESCRIPTION",
                "    Purpose: Build bringup_system.json tests through guided prompts.",
                "    Output: Updated src/main/deploy/bringup_system.json.",
                ...
                "       Output: bringup_system.json + UI ready for command dispatch.",
                "       Commands:",
                "         python -m tools.bringup_test_wizard.gen_bringup_tests",
        ...
        (
            ...
            [
                ...
                "       What it does: Uses a template to populate per-profile tests in bringup_system.json.",
                "       Output: Updated bringup_system.json + UI ready for dispatch.",
                "       Commands:",
                "         python -m tools.test_template_wizard.copy_test_template",
                "         python -m tools.can_nt.can_nt_bridge --ui --no-can",
                "EXAMPLES",
        ...
        (
            ...
            [
                ...
                "       Output: Updated src/main/deploy/bringup_system.json and HTML diagram.",
                "       Commands:",
                "         python -m tools.can_topology.can_top_editor",
                "         python -m tools.sync_profiles",
                "         python -m tools.visualize_profiles",
