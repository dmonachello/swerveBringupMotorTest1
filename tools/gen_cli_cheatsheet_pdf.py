...
def _build_sections() -> List[Tuple[str, Iterable[str]]]:
    ...
    return [
        ...
        (
            ...
            [
                "NAME",
                "    validate_sync - Validate and sync bringup_system.json (canonical -> deploy).",
                "SYNOPSIS",
                ...
                "    Output: Validated/stamped data/bringup_system.json and src/main/deploy/bringup_system.json.",
        ...
        (
            ...
            [
                ...
                "    Output: Updated bringup_system.json (data + deploy).",
